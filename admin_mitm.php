        ...
        <div class="dashboard__right">
            <div id="coursecontent">
                ...
                <div id="lessonContent" class="lesson-content" style="display: none;">
                    ...
                    <h2>Upload Files</h2>
                    <p>
                       <input type="hidden" name="modname" value="MITM" type="text" readonly></input>
                       for MITM <input type="hidden" name="lesson" type="text" id="selectedValue" readonly required></input>
                    ...
                    <p>
                       <input type="hidden" name="modname" value="MITM" type="text" readonly></input>
                       for MITM <input type="hidden" name="lesson" type="text" id="selectedValue2" readonly required></input>
