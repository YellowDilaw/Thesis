...
if ($result->num_rows > 0) {
    ...
    // Concatenate 2 to the current value
    ...
    // Insert a new row with phishing_prog = '2' and user_id if it doesn't exist
    $sql = "INSERT INTO progress (phishing_prog, user_id) VALUES ('2', $user_id)";
