        ...
        <div class="dashboard__left">
            ...
            <?php
              ...
              if ($result->num_rows > 0) 
              {
                while ($row = $result->fetch_assoc()) 
                {
                  ...
                  if ($course4 == 1) 
                  {
                    ...
                    echo '<div class="dashboard__lesson dashboard__lesson1" id="dashboard__lesson-1" onclick="showContent(\'lesson1\')"><p class="text" onClick="changeColor(1)">Introduction to Hacking</p></div>';
                    ...
                    echo '<div class="dashboard__lesson dashboard__lesson3" id="dashboard__lesson-3" onclick="showContent(\'lesson3\')"><p class="text" onClick="changeColor(3)">Importance of Hacking Awareness</p></div>';
                    echo '</div>';
                    echo '<div class="dashboard__assessment">';
                    echo '<button id="openModalButton" onclick="showContent(\'assessment\')">Assessment</button>';
                  }
                  else if($course4 == 0){
                    echo '<form action="enroll4.php" method="post">
              ...
              if ($result->num_rows > 0) {
                  ...
                  // Check for concatenated numbers in hacking_prog
        ...
        <div class="dashboard__right">
            <div id="coursecontent">
                ...
                <div id="lesson1Content" class="lesson-content" style="display: none;">
                    ...
                    <p>
                    <?php if (!$hideButton1): ?>
                    <form action="hackingprog1.php" method="post">
                ...
                <div id="lesson2Content" class="lesson-content" style="display: none;">
                    ...
                    <?php if (!$hideButton2): ?>
                    <form action="hackingprog2.php" method="post">
                        <input type="hidden" name="update_action" value="update_column_1">
                        <input type="submit" id="doneButton" name="update_button" value="Mark as Done" />
                    </form>
                    <?php endif; ?>
                ...
                <div id="lesson3Content" class="lesson-content" style="display: none;">
                    ...
                    <?php if (!$hideButton3): ?>
                    <form action="hackingprog3.php" method="post">
                        <input type="hidden" name="update_action" value="update_column_1">
                        <input type="submit" id="doneButton" name="update_button" value="Mark as Done" />
                    </form>
                    <?php endif; ?>
