...
if($result->num_rows > 0){
    ...
    // Update Course4 column with '1' and the user_id
    $sql = "UPDATE courses SET Course4 = 1, user_id = $user_id WHERE user_id = $user_id";
    ...
    // Insert a new row with Course4 = 1 and user_id
    $sql = "INSERT INTO courses (Course4, user_id) VALUES (1, $user_id)";
