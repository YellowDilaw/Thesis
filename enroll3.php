...
if($result->num_rows > 0){
    ...
    // Update Course3 column with '1' and the user_id
    $sql = "UPDATE courses SET Course3 = 1, user_id = $user_id WHERE user_id = $user_id";
    ...
    // Insert a new row with Course3 = 1 and user_id
    $sql = "INSERT INTO courses (Course3, user_id) VALUES (1, $user_id)";
